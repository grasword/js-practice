...
console.log('Task 1: Find the total price of products: ', findTotalPrice(products))
...
console.log('Task 2: Find the sum of price of products using only reduce', getSum(products))
...
const getFirstTenCountries = (c) => c.splice(0, 10)

console.log('Task 3: FirstTenCountries \n', getFirstTenCountries(countries))
...
console.log('Task 4: LastTenCountries \n', getLastTenCountries(countries))
...
console.log('Sort countries by name \n', sortBy('name', countries))
console.log('Sort countries by capital \n', sortBy('capital', countries))
console.log('Sort countries by population \n', sortBy('population', countries))
...
console.log('Task 6: 10 most spoken languages ', mostSpokenLanguages(countries, 10))
...
console.log('Task 7: ten most populated countries ', mostPopulatedCountries(10))
