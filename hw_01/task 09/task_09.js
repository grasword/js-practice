...
console.log('Task 1: A b union -', unionArr)

// 2. Find a intersection b
const A = new Set(a)
const B = new Set(b)
const intersection = a.filter((num) => B.has(num))
console.log('Task 2: A B intersection -', intersection)

// 3. Find a with b
const difference = a.filter((num) => !B.has(num))
console.log('Task 3: A B difference -', difference)
...
const getNumberOfLanguagesFP = (a) => {
  const unique = new Set(a.map((c) => c.languages).flat())
  return unique.size
}

// console.log('Number of Languages - ', getNumberOfLanguages(countries))
console.log('Task 4: Number of Languages in the countries object file - ', getNumberOfLanguagesFP(countries))
